...
public class Login extends javax.swing.JFrame {
    ...
    String JDBCU;
    String JDBCP;
    DateFormat df,df2; Date d,d1;
    String userAd,passAd;
    ...
    public Login() {
        ...
        userAd = new AdminInfo().getAdminUsername();
        passAd = new AdminInfo().getAdminPassword();
        
        JDBCC = new DatabaseInfo().getConnection();
        JDBCU = new DatabaseInfo().getUsername();
        JDBCP = new DatabaseInfo().getPassword();
    ...
    private void signInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signInActionPerformed
        ...
        try{
            ...
            con=DriverManager.getConnection(JDBCC,JDBCU,JDBCP);
            ...
            else if(userId.equals(userAd)==true){
                if(userPass.equals(passAd)==true){
            ...
            else if(userId.equals(userAd)==false){
                try{
                    rs=stmt.executeQuery("select username from APP.PROFILE where username= '"+userId+"' ");
                    rs.first();
